...
export const ENTER_DN = 'Please enter the device number available at the back of the sensor'
...
export const OBS_SELECT_DATE_TEXT = "Please select the date the video was recorded."
...
export const BFISCORE_INST = "Time to give the pet pics the star treatment! Score your furry friends' BFI based on the awesome snapshots provided."
...
export const CAPTURED_ORIENTATION_ERROR_MESSAGE = "Oh no! The captured image doesn't match the selected pet image orientation. Would you like to proceed with Ignore/Re-Take"
...
export const CAPTURED_SUBMIT_IMAGES_SUCCESS = "Success! Your Pets Capture BFI images have been submitted"
