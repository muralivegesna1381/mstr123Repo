...
export const REGISTRATION_SUCCESS = "You have successfully registered to the WAG app.";
...
export const CAMERA_PERMISSION_MSG = 'Please turn on your Camera and Microphone Permissions in order to continue (Device Settings > WAG App > Enable Camera and Microphone permissions).'
export const CAMERA_PERMISSION_MSG_HIGHLIGHTED = 'Device Settings > WAG App > Enable Camera and Microphone permissions.'
export const GALLERY_PERMISSION_MSG = 'Please turn on your Media selection Permissions in order to continue (Device Settings > WAG App > Photos > All Photos or Selected Photos).'
export const GALLERY_PERMISSION_MSG_HIGHLIGHTED = 'Device Settings > WAG App > Photos > All Photos or Selected Photos'
export const CAMERA_PERMISSION_MSG_ANDROID = 'Please turn on your Camera Permissions in order to continue.\nPlease make sure you have granted the required Camera permissions. If not please go to Phone Settings > WAG App > Permissions > Camera > Allow permissions.'
export const CAMERA_PERMISSION_MSG_HIGHLIGHTED_ANDROID = 'Phone Settings > WAG App > Permissions > Camera > Allow permissions.'
export const GALLERY_PERMISSION_MSG_ANDROID = 'Please turn on your Media Permissions in order to continue.\nPlease make sure you have granted the required media permissions. If not please go to Phone Settings > WAG App > Permissions > Photos and videos > Allow permissions.'
export const GALLERY_PERMISSION_MSG_HIGHLIGHTED_ANDROID = 'Phone Settings > WAG App > Permissions > Photos and videos > Allow permissions.'
export const BLE_TURN_ON = 'Please turn on your device bluetooth in order to continue.'
export const BLE_PERMISSIONS_ENABLED_HIGH = 'Phone Settings > WAG App > Enable Bluetooth permission'
export const BLE_PERMISSIONS_ENABLED = 'Please turn on your Bluetooth in order to continue.\nPlease make sure you have granted the required Bluetooth permissions. If not please go to Phone Settings > WAG App > Enable Bluetooth permission.'
export const BLE_PERMISSIONS_ENABLED_HIGH_ANDROID = 'Phone Settings > Apps > WAG > Permissions > Nearby devices > Enable permission'
export const BLE_PERMISSIONS_ENABLED_ANDROID = 'Please turn on your Bluetooth in order to continue.\nPlease make sure you have granted the required Nearby devices permissions. If not please go to Phone Settings > Apps > WAG > Permissions > Nearby devices > Enable permission'
...
export const ANDROID_TIMER_NOTI_MSG = 'Would you like to receive timer notifications? \n\nIf yes, please select YES below and disable battery optimization by searching for WAG app and tapping on toggle.'
...
export const APPSTORE_LINK = 'https://apps.apple.com/us/app/wearables-clinical-trials/id1477593894';
export const PLAYSTORE_LINK = 'https://play.google.com/store/search?q=wearables+clinical+trials&c=apps&hl=en-IN';
