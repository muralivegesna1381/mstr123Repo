...
export const ALL_PETS_ARRAY = "allPetsArray";
...
export const AUTO_LOGOUT_MSG = "You've exceeded the limit of 3 concurrent logins. You will be logged out from the first device.";
...
export const PSWD_MATCH = "New password does not match the current password";
