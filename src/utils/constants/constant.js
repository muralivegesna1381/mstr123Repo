...
export const REGISTRATION_SUCCESS = "You have successfully registered to the Wearables app.";
...
export const APPUPDATE_OPTIONAL_MSG = "Upgrade Unleashed!  Elevate your experience with Wearables Mobile App update. Dive into new features and smoother performance. Ready to level up? Click to upgrade now!";
export const APPUPDATE_FORCE_MSG = "Your continued access may be affected without upgrading the Wearables mobile app. Some features may become unavailable, and you might experience potential performance issues.";
