                        ...
                        renderItem={({ item, index }) => (
                            <TouchableOpacity disabled={true} onPress={() => actionOnRow(item)}>
                              ...
                              <ImageBackground source={require("./../../../../../assets/images/otherImages/svg/defaultDogIcon_dog.svg")} style={styles.media} imageStyle={{borderRadius:5}}>
                                ...
                                ) : (mediaArray.length> 0 && mediaArray[index].filePath && mediaArray[index].filePath!=='' ? <ImageBackground source={{uri : Platform.OS === 'ios' ? mediaArray[index].filePath : mediaArray[index].localThumbImg}} style={styles.media} imageStyle={{borderRadius:5}}>
