...
public class ActVideoTrimmer extends LocalizationActivity {
    ...
    private void setUpToolBar(ActionBar actionBar, String title) {
        try {
            ...
            actionBar.setHomeAsUpIndicator(R.drawable.ic_close1);
...
//              String path = FileUtils.getPath(ActVideoTrimmer.this, uri);
    ...
    private void setUpSeekBar() {
        ...
        seekbar.setMaxStartValue((float) 1200).apply();
        if (trimType == 1) {
...
//            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_done) {
            ...
            if(lastMaxValue-lastMinValue>1200){
                //Log.v("TAGG","CONDITION FAILED::");
                Toast.makeText(this, getString(R.string.txt_smaller), Toast.LENGTH_SHORT).show();

            }
            else{
                //Log.v("TAGG","CONDITION PASS::");
                trimVideo();
            }
    ...
    private static int getDuration(File file) {
        ...
        int minutes = (int) (Long.parseLong(durationStr) % (1000 * 60 * 60)) / (1000 * 60);
        return minutes;
    }
